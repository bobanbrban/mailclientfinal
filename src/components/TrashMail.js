...
class Mail extends Component {
  onClickReaded = () => {
     ...
     const { onSetRightTrash } = this.props;
     onSetReaded();
     onSetRightTrash();
  }
  onClickReadedBack = () => {
  ...
  const mapDispachToProps = (dispatch,ownProps)=> ({
    ...
    onSetRightTrash: () => dispatch({type: actionTypes.SET_RIGHT_TRASH, id: ownProps.mail.id}),
  });
  const TrashMail = connect(mapStateToProps, mapDispachToProps)(Mail);
