...
class Mail extends Component {
  onClickReaded = () => {
     ...
     const { onSetRightSpam } = this.props;
     onSetReaded();
     onSetRightSpam();
  }
  onClickReadedBack = () => {
  ...
  const mapDispachToProps = (dispatch,ownProps)=> ({
    ...
    onSetRightSpam: () => dispatch({type: actionTypes.SET_RIGHT_SPAM, id: ownProps.mail.id}),
  });
const SpamMail = connect(mapStateToProps, mapDispachToProps)(Mail);
